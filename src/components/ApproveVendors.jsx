...
const ApproveVendors = () => {
  ...
  const handleApprove = async (vendorId) => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:8080/admin/vendor/approve/${vendorId}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const handleReject = async (vendorId) => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:8080/admin/vendor/reject/${vendorId}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
