...
const ApproveSnacks = () => {
  ...
  const fetchSnacks = async () => {
    try {
      ...
      const response = await fetch('https://vegansnackappbackend-production.up.railway.app/admin/snacks', {
        headers: {
  ...
  const handleApprove = async (snackId) => {
    ...
    try {
      ...
      const response = await fetch(`https://vegansnackappbackend-production.up.railway.app/admin/snack/approve/${snackId}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const handleReject = async (snackId) => {
    ...
    try {
      ...
      const response = await fetch(`https://vegansnackappbackend-production.up.railway.app/admin/snack/reject/${snackId}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
